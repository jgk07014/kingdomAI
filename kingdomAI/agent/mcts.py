...
from kingdomAI.utils import coords_from_point
...
class MCTSNode(object):
    def __init__(self, game_state, parent=None, move=None):
        ...
        self.num_rollouts = 0
        self.children = []
        self.unvisited_moves = game_state.legal_moves2()
...
class MCTSAgent(agent.Agent):
    ...
    def simulate_random_game(game):
        bots = {
            Player.black: agent.naive.HeuristicsBot(),
            Player.white: agent.naive.HeuristicsBot(),
        }
